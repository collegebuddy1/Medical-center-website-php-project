...
<form method="post" action="accounts2.php"> 
   Date:<br>   <input id="date" name="date" value="<?php echo date("M j, Y "); ?>"/>
      <span class="error">* </span>
  <br><br>
   Doctor Name:<br> <input type="text" name="DOCNAME">
   <span class="error">* </span>
  <br><br>
   Patient Name: <br><input type="text" name="patname">
   <span class="error">* </span>
   <br><br>
   Patient Contact: <br><input type="text" name="phonenumber">
   
   <br><br>
    Patient Address: <br><input type="text" name="address">
  
   <br><br>
    Investigations: <br><input type="text" name="diag">
   <span class="error">* </span>
   <br><br>
